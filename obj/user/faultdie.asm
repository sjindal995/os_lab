...
handler(struct UTrapframe *utf)
{
  ...
  80005b:	c7 04 24 e0 14 80 00 	movl   $0x8014e0,(%esp)
...
umain(int argc, char **argv)
{
  ...
  800083:	e8 bd 10 00 00       	call   801145 <set_pgfault_handler>
	*(int*)0xDeadBeef = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022b:	e8 10 10 00 00       	call   801240 <__udivdi3>
  ...
  800297:	e8 d4 10 00 00       	call   801370 <__umoddi3>
  80029c:	05 e8 15 80 00       	add    $0x8015e8,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003c3:	8b 04 85 0c 16 80 00 	mov    0x80160c(,%eax,4),%eax
  ...
  8004ce:	c7 44 24 08 02 16 80 	movl   $0x801602,0x8(%esp)
  8004d5:	00 
  ...
  8004fa:	75 05                	jne    800501 <vprintfmt+0x1af>
				p = "(null)";
  8004fc:	be 05 16 80 00       	mov    $0x801605,%esi
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800dfd:	c7 44 24 08 64 17 80 	movl   $0x801764,0x8(%esp)
  800e04:	00 
  800e05:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e0c:	00 
  800e0d:	c7 04 24 81 17 80 00 	movl   $0x801781,(%esp)
  800e14:	e8 c6 03 00 00       	call   8011df <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80114b:	a1 08 20 80 00       	mov    0x802008,%eax
  801150:	85 c0                	test   %eax,%eax
  801152:	75 5d                	jne    8011b1 <set_pgfault_handler+0x6c>
		// First time through!
  ...
  801154:	a1 04 20 80 00       	mov    0x802004,%eax
  801159:	8b 40 48             	mov    0x48(%eax),%eax
  80115c:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  801163:	00 
  801164:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  80116b:	ee 
  80116c:	89 04 24             	mov    %eax,(%esp)
  80116f:	e8 01 fe ff ff       	call   800f75 <sys_page_alloc>
  801174:	89 45 f4             	mov    %eax,-0xc(%ebp)
  801177:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  80117b:	79 1c                	jns    801199 <set_pgfault_handler+0x54>
  80117d:	c7 44 24 08 90 17 80 	movl   $0x801790,0x8(%esp)
  801184:	00 
  801185:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  80118c:	00 
  80118d:	c7 04 24 bc 17 80 00 	movl   $0x8017bc,(%esp)
  801194:	e8 46 00 00 00       	call   8011df <_panic>
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  801199:	a1 04 20 80 00       	mov    0x802004,%eax
  80119e:	8b 40 48             	mov    0x48(%eax),%eax
  8011a1:	c7 44 24 04 bb 11 80 	movl   $0x8011bb,0x4(%esp)
  8011a8:	00 
  8011a9:	89 04 24             	mov    %eax,(%esp)
  8011ac:	e8 cf fe ff ff       	call   801080 <sys_env_set_pgfault_upcall>
  ...
  8011b4:	a3 08 20 80 00       	mov    %eax,0x802008
}
  8011b9:	c9                   	leave  
  8011ba:	c3                   	ret    
...
_pgfault_upcall:
  ...
  8011d1:	89 65 30             	mov    %esp,0x30(%ebp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8011ec:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8011f2:	e8 f6 fc ff ff       	call   800eed <sys_getenvid>
  8011f7:	8b 55 0c             	mov    0xc(%ebp),%edx
  8011fa:	89 54 24 10          	mov    %edx,0x10(%esp)
  8011fe:	8b 55 08             	mov    0x8(%ebp),%edx
  801201:	89 54 24 0c          	mov    %edx,0xc(%esp)
  801205:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  801209:	89 44 24 04          	mov    %eax,0x4(%esp)
  80120d:	c7 04 24 cc 17 80 00 	movl   $0x8017cc,(%esp)
  801214:	e8 9f ef ff ff       	call   8001b8 <cprintf>
  ...
  801226:	e8 29 ef ff ff       	call   800154 <vcprintf>
	cprintf("\n");
  80122b:	c7 04 24 ef 17 80 00 	movl   $0x8017ef,(%esp)
  801232:	e8 81 ef ff ff       	call   8001b8 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  801237:	cc                   	int3   
  801238:	eb fd                	jmp    801237 <_panic+0x58>
