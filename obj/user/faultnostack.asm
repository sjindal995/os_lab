...
umain(int argc, char **argv)
{
  ...
  800039:	c7 44 24 04 82 04 80 	movl   $0x800482,0x4(%esp)
  800040:	00 
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000f7:	c7 44 24 08 ea 14 80 	movl   $0x8014ea,0x8(%esp)
  8000fe:	00 
  8000ff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800106:	00 
  800107:	c7 04 24 07 15 80 00 	movl   $0x801507,(%esp)
  80010e:	e8 93 03 00 00       	call   8004a6 <_panic>
...
void sys_exec(char* buf){
  ...
  800442:	83 ec 28             	sub    $0x28,%esp
	syscall(SYS_exec, 0, (uint32_t)buf, 0 , 0, 0, 0);
  800445:	8b 45 08             	mov    0x8(%ebp),%eax
  800448:	c7 44 24 18 00 00 00 	movl   $0x0,0x18(%esp)
  80044f:	00 
  800450:	c7 44 24 14 00 00 00 	movl   $0x0,0x14(%esp)
  800457:	00 
  800458:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%esp)
  80045f:	00 
  800460:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
  800467:	00 
  800468:	89 44 24 08          	mov    %eax,0x8(%esp)
  80046c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  800473:	00 
  800474:	c7 04 24 0d 00 00 00 	movl   $0xd,(%esp)
  80047b:	e8 3d fc ff ff       	call   8000bd <syscall>
}
  800480:	c9                   	leave  
  800481:	c3                   	ret    

00800482 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800483:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  800488:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  80048a:	83 c4 04             	add    $0x4,%esp
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8004b9:	e8 29 fd ff ff       	call   8001e7 <sys_getenvid>
  ...
  8004d4:	c7 04 24 18 15 80 00 	movl   $0x801518,(%esp)
  ...
  8004ed:	e8 6b 00 00 00       	call   80055d <vcprintf>
	cprintf("\n");
  8004f2:	c7 04 24 3b 15 80 00 	movl   $0x80153b,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  80053e:	e8 db fb ff ff       	call   80011e <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8005b4:	e8 65 fb ff ff       	call   80011e <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800634:	e8 17 0c 00 00       	call   801250 <__udivdi3>
  ...
  8006a0:	e8 db 0c 00 00       	call   801380 <__umoddi3>
  8006a5:	05 08 16 80 00       	add    $0x801608,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007cc:	8b 04 85 2c 16 80 00 	mov    0x80162c(,%eax,4),%eax
  ...
  8008d7:	c7 44 24 08 22 16 80 	movl   $0x801622,0x8(%esp)
  8008de:	00 
  ...
  800903:	75 05                	jne    80090a <vprintfmt+0x1af>
				p = "(null)";
  800905:	be 25 16 80 00       	mov    $0x801625,%esi
			if (width > 0 && padc != '-')
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  8011d2:	a1 08 20 80 00       	mov    0x802008,%eax
  8011d7:	85 c0                	test   %eax,%eax
  8011d9:	75 5d                	jne    801238 <set_pgfault_handler+0x6c>
		// First time through!
		// LAB 4: Your code here.
  ...
  8011f6:	e8 74 f0 ff ff       	call   80026f <sys_page_alloc>
  8011fb:	89 45 f4             	mov    %eax,-0xc(%ebp)
  8011fe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801202:	79 1c                	jns    801220 <set_pgfault_handler+0x54>
  801204:	c7 44 24 08 84 17 80 	movl   $0x801784,0x8(%esp)
  80120b:	00 
  80120c:	c7 44 24 04 20 00 00 	movl   $0x20,0x4(%esp)
  801213:	00 
  801214:	c7 04 24 b0 17 80 00 	movl   $0x8017b0,(%esp)
  80121b:	e8 86 f2 ff ff       	call   8004a6 <_panic>
		sys_env_set_pgfault_upcall(thisenv->env_id, _pgfault_upcall);
  801220:	a1 04 20 80 00       	mov    0x802004,%eax
  801225:	8b 40 48             	mov    0x48(%eax),%eax
  801228:	c7 44 24 04 82 04 80 	movl   $0x800482,0x4(%esp)
  80122f:	00 
  801230:	89 04 24             	mov    %eax,(%esp)
  801233:	e8 42 f1 ff ff       	call   80037a <sys_env_set_pgfault_upcall>
  ...
  80123b:	a3 08 20 80 00       	mov    %eax,0x802008
}
  801240:	c9                   	leave  
  801241:	c3                   	ret    
